...
class BaseTextCategorizationDataset:
    ...
    def to_indexes(self, labels):
        ...
        """
        return np.array([self.get_label_to_index_map()[label] for label in labels])
...
class LocalTextCategorizationDataset(BaseTextCategorizationDataset):
    ...
    def __init__(self, filename, batch_size,
        ...
        self._label_list = sorted(list(set(self._dataset['tag_name'])))
    ...
    def load_dataset(filename, min_samples_per_label):
        ...
        expected_columns = ['post_id', 'tag_name',
                            'tag_id', 'tag_position', 'title']
    ...
    def _get_label_list(self):
        ...
        returns label list
        """
        return sorted(self._dataset['tag_name'].unique())
